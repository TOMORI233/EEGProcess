...
set(gca, 'FontSize', 12);
text(1:4, repmat(max(get(gca, "YLim")) - 0.5, [1, 4]), num2str(pREG'), "HorizontalAlignment", "center", "FontSize", 12);
text(1:4, repmat(max(get(gca, "YLim")) - 1, [1, 4]), num2str(pREG2'), "HorizontalAlignment", "center", "FontSize", 12);
xticks(1:5);
