    ...
    switch protocolID
        ...
        case 6 % decoding: code 181~194
         ...
         case 7 % TITS: code 211~212
            [sounds{1}, fs] = audioread('sounds\2022-11-09_TITS\interval 0\3s_24_26.4_RegStdDev.wav');
            sounds{2} = audioread('sounds\2022-11-09_TITS\interval 0\3s_24_60_RegDevStd.wav');
            sounds = cellfun(@(x) 10*x, sounds, 'UniformOutput', false);
    end
