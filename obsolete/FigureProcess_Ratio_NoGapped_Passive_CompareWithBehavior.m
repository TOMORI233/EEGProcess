...
FIGUREPATH = getAbsPath("..\Figures\healthy\population\Ratio No-Gapped Passive (Compare with behavior)");
...
tcP1 = [1167; 1161; 1138; 1135; 1123];
tcN2 = [1255; 1236; 1233; 1215; 1204];
...
save(['..\DATA\MAT DATA\figure\Res P3 compare (', char(area), ').mat'], ...
     "fs", ...
     "ICIsREG", ...
     "chData", ...
     params0{:});
