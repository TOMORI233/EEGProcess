...
addLines2Axes(struct("X", {0; 1000; 1000 + interval; 2000 + interval}, "color", [255 128 0] / 255, "width", 1.5));
scaleAxes("x", [1000, 1800] + interval);
...
windowChange = 1000 + interval + 350 + [-25, 25];
...
addLines2Axes(gca, struct("X", {0; 1000; 1000 + interval; 2000 + interval}));
scaleAxes("x", [1000, 1800] + interval);
...
plotRawWaveMulti(tempData, window);
