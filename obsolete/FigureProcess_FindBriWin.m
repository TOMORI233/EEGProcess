...
%% For A1, P2, P3
load("..\DATA\MAT DATA\population\chMean_P3_Population.mat");
...
%% For A2
load("..\DATA\MAT DATA\population\chMean_A2_Population.mat");
...
%% For P1
load("..\DATA\MAT DATA\population\chMean_P1_Population.mat");
