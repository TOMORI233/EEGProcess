function batchExportNeuracle(DATAROOTPATH, SAVEROOTPATH, pIDs, opts)
...
% >> batchExportNeuracle(DATAROOTPATH, SAVEROOTPATH, [], opts);
% 
% To export data of multiple protocols with different analysis window, use:
% >> batchExportNeuracle(DATAROOTPATH, SAVEROOTPATH, pID1, ...
%                        preprocessConfigEEG("window", window1));
% >> batchExportNeuracle(DATAROOTPATH, SAVEROOTPATH, [pID2, pID3], ...
